...
////////////////////////////////////////////////////////////////////////////////
$conf['db_software'] = 'MySQL';		// preferred database
/** for historical reasons these fields reference mysql even though the database **
 ** might be a different software                                                **/
$conf['mysql_user'] = $_ENV["OPENSHIFT_MYSQL_DB_USERNAME"];           // Supply your Database user id.
$conf['mysql_pass'] = $_ENV["OPENSHIFT_MYSQL_DB_PASSWORD"];           // Supply your Database password.
$conf['mysql_host'] = $_ENV["OPENSHIFT_MYSQL_DB_HOST"];  // Supply the name of your Database server.
$conf['mysql_database'] = $_ENV["OPENSHIFT_GEAR_NAME"];       // Supply the name of Zenphoto's database
